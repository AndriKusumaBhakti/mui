...
class PrivacyPolice extends KFDrawerContent {
  PrivacyPolice({Key key, this.url});
  final String url;
...
class _MainPageState extends State<PrivacyPolice> {
  ...
  void service() async{
    Config.log('PRIVACY : '+(await Prefs.getPRIVACY).toString());
    url = (await Prefs.getPRIVACY) != null && (await Prefs.getPRIVACY).isNotEmpty ? await Prefs.getPRIVACY:widget.url;
    setState(() {});
  }
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Text("Privacy Police", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center,),
                Spacer(),
                InkWell(
                  child: Container(
                    height: 40,
