...
class WebUrlFacebook extends KFDrawerContent {
  WebUrlFacebook({Key key, this.url});
...
class _MainPageState extends State<WebUrlFacebook> {
  ...
  void service() async{
    Config.log('FB : '+(await Prefs.getFB).toString());
    url = (await Prefs.getFB) != null && (await Prefs.getFB).isNotEmpty ? await Prefs.getFB:widget.url;
    setState(() {});
  }
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Text("Facebook", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center,),
                Spacer(),
                InkWell(
                  child: Container(
                    height: 40,
