...
class WebUrlYoutobe extends KFDrawerContent {
  WebUrlYoutobe({Key key, this.url});
...
class _MainPageState extends State<WebUrlYoutobe> {
  ...
  void service() async{
    Config.log('YTB : '+(await Prefs.getYTB).toString());
    url = (await Prefs.getYTB) != null && (await Prefs.getYTB).isNotEmpty ? await Prefs.getYTB:widget.url;
    setState(() {});
  }
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Text("Youtube", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: Colors.white)),
                Spacer(),
                InkWell(
                  child: Container(
                    height: 40,
