...
<head>
  ...
  <title>Kategori Berita - MUI-TV</title>
  ...
  <?php 
    if(isset($_GET['pesan'])){
      if($_GET['pesan'] == "gagal_hapus"){
        echo "<div style='margin-bottom:-55px' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>  Gagal dalam menghapus data !!</div>";
      }else if($_GET['pesan'] == "gagal_request"){
        echo "<div style='margin-bottom:-55px' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>  Request ada yang kurang !!</div>";
      }
    }
  ?>
  <!-- ======= Header ======= -->
    ...
    <section class="section dashboard">
     ...
     <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title"><span>Kategori Berita</span></h5>
                  <form action="tambah_data.php" method="post">
                    <input type="hidden" name="add" id="add" value="<?php echo 'kategori';?>"/>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                    <?php 
                      $brg=mysqli_query($conn, "select * from master_data where tipe = 'kategori' order by kode asc");
                      $no=1;
                        ...
                        <tr>
                          ...
                          <td>
                            <form action="edit_data.php" method="post">
                                ...
                                <input type="hidden" name="update" id="update" value="<?php echo 'kategori';?>"/>
                                <button type="submit" class="bi bi-pencil-square"></button>
                            </form>
                            <form action="hapus_data.php" method="get">
                                <input type="hidden" name="id" id="id" value="<?php echo $b['id'];?>"/>
                                <input type="hidden" name="from" id="from" value="<?php echo 'kategori';?>"/>
