...
<head>
  ...
  <title>Link Media Sosial - MUI-TV</title>
     ...
     <div class="row">
        <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title"><span>Link Media Sosial</span></h5>
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        <th class="col-md-1">No</th>
                        <th class="col-md-2">Media Sosial</th>
                    ...
                    <tbody>
                    <?php 
                      $brg=mysqli_query($conn, "select * from master_data where tipe IN ('youtube', 'website', 'facebook', 'twitter'
                      , 'instagram', 'privacy_police') order by id asc");
                      $no=1;
                      while($b=mysqli_fetch_array($brg)){
                        ...
                        <tr>
                          ...
                          <td><a href = "<?php echo $b['kode'] ?>"><?php echo $b['kode'] ?></a></td>
                          <td><?php echo $b['deskripsi'] ?></td>
                          <td>
                            <form action="edit_data.php" method="post">
                                <input type="hidden" name="id" id="id" value="<?php echo $b['id'];?>"/>
                                <input type="hidden" name="update" id="update" value="<?php echo 'media_sosial';?>"/>
